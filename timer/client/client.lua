...
--     if isDead and reviveTimer <= 0 then -- Проверяем, что игрок мёртв и таймер истёк перед показом экрана
...
--         })
--     else
--         if not isDead or reviveTimer > 0  then
--             print("[DEBUG] ShowRespawnScreen called, but player is not dead")
--         else
--             print("[DEBUG] ShowRespawnScreen called, but revive timer has not expired yet")
--         end
--     end
-- end

-- -- Функция для скрытия черного экрана
